...
function isPasswordValid(password) {
  ...
  passwordArr.forEach(function(char) {
    if (passwordArr.length >= 8) {
      storeData[0] = true;
    }
  
    if (passSplitUpper.some(function(UpperChar) {
      return UpperChar === char;
    })) {
      storeData[1] = true;
    }
  
    if (passSplitLower.some(function(LowerChar) {
      return LowerChar === char;
    })) {
      storeData[2] = true;
    }
  
    if (passwordDigit.split('').some(function(Digit) {
      return Digit === char;
    })) {
      storeData[3] = true;
    }
  
    if (passwordSpecial.split('').some(function(Digit) {
      return Digit === char;
    })) {
      storeData[4] = true;
    }
